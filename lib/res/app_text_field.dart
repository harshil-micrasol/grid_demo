...
class _AppTextFieldState extends State<AppTextField> {
        ...
        children: [
          if (widget.title != null && widget.title!.isNotEmpty) ...[
            FieldTitleWidget(
              ...
              padding: widget.titlePadding ?? const EdgeInsets.only(bottom: 5),
            ),
          ],
  ...
  TextFormField textFieldWidget(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: widget.hintStyle ?? TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w400, color: Colors.grey),
        contentPadding: widget.contentPadding ?? const EdgeInsets.all(18),
        prefixIcon: widget.prefixIcon != null
            ? InkWell(
                overlayColor: MaterialStateProperty.all(Theme.of(context).brightness == Brightness.dark ? null : Colors.transparent),
        ...
        enabledBorder: widget.enabledBorder ??
            OutlineInputBorder(
              ...
              borderSide: BorderSide(color: widget.showError == false ? Colors.grey.shade700 : Theme.of(context).colorScheme.error),
            ),
        ...
        focusedBorder: widget.focusedBorder ??
            OutlineInputBorder(
              borderRadius: filedBorderRadius,
              borderSide: BorderSide(color: widget.readOnly == true ? Colors.grey.shade700 : Theme.of(context).primaryColor),
            ),
  ...
  TextStyle get textFormFieldStyle {
    return widget.style ?? TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w500);
  }
}
      ...
      child: AnimatedDefaultTextStyle(
        ...
        style: titleStyle ??
            TextStyle(
              ...
              color: isFieldActive == true ? (readOnly == true ? Colors.grey.shade700 : Theme.of(mainContext).primaryColor) : Colors.grey.shade700,
            ),
        child: Text(
          title,
        ),
