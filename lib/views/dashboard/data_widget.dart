...
class Pub extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        color: Colors.white,
        child: Container(alignment: Alignment.center, decoration: const BoxDecoration(image: DecorationImage(fit: BoxFit.contain, image: AssetImage("assets/pub_dev.png")))),
      ),
    );
  }
}
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Container(alignment: Alignment.center, decoration: const BoxDecoration(image: DecorationImage(fit: BoxFit.contain, image: AssetImage("assets/linkedin.png")))),
            ),
          ],
        ),
      ),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Container(alignment: Alignment.center, decoration: const BoxDecoration(image: DecorationImage(fit: BoxFit.contain, image: AssetImage("assets/twitter.png")))),
            ),
          ],
        ),
      ),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Container(margin: const EdgeInsets.all(5), alignment: Alignment.center, decoration: const BoxDecoration(image: DecorationImage(fit: BoxFit.contain, image: AssetImage("assets/github.png")))),
            ),
          ],
        ),
      ),
...
class BuyMee extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(alignment: Alignment.center, decoration: const BoxDecoration(image: DecorationImage(fit: BoxFit.cover, image: AssetImage("assets/img.png")))),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: const Column(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
          children: [
            AutoSizeText("Each widget on the screen is called \"DashboardItem\"", maxLines: 4, style: TextStyle(color: Colors.white, fontSize: 13), textAlign: TextAlign.center),
            AutoSizeText("Each has a location and dimensions by slots.", maxLines: 3, style: TextStyle(color: Colors.white, fontSize: 13), textAlign: TextAlign.center),
            Row(
              children: [
                Expanded(
                  child: AutoSizeText("You can switch to edit mode to see these slots.", maxLines: 4, style: TextStyle(color: Colors.white, fontSize: 13), textAlign: TextAlign.center),
                ),
                SizedBox(
                  width: 8,
                ),
        ...
        child: Row(
          children: [
            ...
            const Expanded(
              ...
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                AutoSizeText("Users can resize widgets.", maxLines: 2, style: TextStyle(color: Colors.white, fontSize: 13), textAlign: TextAlign.center),
                AutoSizeText(
                    ...
                    style: TextStyle(color: Colors.white, fontSize: 13),
                    textAlign: TextAlign.center),
                AutoSizeText("Don't forget switch to edit mode.", maxLines: 3, style: TextStyle(color: Colors.white, fontSize: 13), textAlign: TextAlign.center),
              ],
            ))
          ],
        ));
