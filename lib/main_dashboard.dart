...
// import 'views/dashboard/add_dialog.dart';
// import 'views/dashboard/data_widget.dart';
// import 'views/dashboard/storage.dart';
...
//         children: [
//           const Text("style_dart framework documentation coming soon...", textAlign: TextAlign.center),
//           const SizedBox(
//             height: 20,
//           ),
//           Container(
...
//   ///
//   late var itemController = DashboardItemController<ColoredDashboardItem>.withDelegate(itemStorageDelegate: storage);
...
//                   return Text("$e , $s");
//                 },
//                 itemStyle: ItemStyle(color: Colors.transparent, clipBehavior: Clip.antiAliasWithSaveLayer, elevation: 5, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15))),
